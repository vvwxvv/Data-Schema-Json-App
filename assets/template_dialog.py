...
from .templates import SchemaTemplate, TemplateManager
...
class TemplatePreviewDialog(ModernDialog):
    ...
    def _setup_template_ui(self):
        ...
        self.schema_name_input.setPlaceholderText("Enter schema name...")
    ...
    def _create_minimal_template_list(self) -> QWidget:
        ...
        # Add templates
        for template_id, template in self.template_manager.get_all_templates().items():
            ...
            name_label = QLabel(template.name.upper())
    ...
    def _on_template_selected(self, item):
        ...
        if template:
            ...
            # Update preview
            preview_data = {
                self.schema_name_input.text() or "schema_name": template.preview_data
            }
    ...
    def _show_template_info(self, template: SchemaTemplate):
        ...
        for var_type in [
            ...
            count = len(template.preview_data.get(var_type, []))
            if count > 0:
    ...
    def _update_apply_button(self):
        ...
        self.apply_btn.setEnabled(
            ...
            and self.schema_name_input.text().strip() != ""
        )
    ...
    def _apply_template(self):
        ...
        if self.selected_template and self.schema_name_input.text().strip():
            self.accept()
