...
from .template_writing import WritingTemplate
from .template_webservice import WebServiceTemplate
from .template_inquire import InquiryTemplate
from .template_webbookmark import WebBookmarkTemplate
...
class TemplateRegistry:
    ...
    def _register_default_templates(self):
        ...
        self.auto_register(WritingTemplate)
        self.auto_register(WebServiceTemplate)
        self.auto_register(InquiryTemplate)
        self.auto_register(WebBookmarkTemplate)
