...
class TemplatePreviewDialog(ModernDialog):
    ...
    # Font size parameters for easy adjustment (increased by 3px)
    label_font_size = 23
    input_font_size = 29
    button_font_size = 23
    header_font_size = 23
    ...
    preview_font_size = 21
    copy_button_font_size = 23
    ...
    def _setup_template_ui(self):
        ...
        name_label.setStyleSheet(f"font-weight: 600; font-size: {self.label_font_size}px;")
        ...
        # Responsive: set initial size to 60% of screen, allow resizing
    ...
    def _create_minimal_template_list(self) -> QWidget:
        ...
        self.template_list.setStyleSheet(
            ...
            QListWidget::item {{
                padding: 20px 20px;
                border-bottom: 1px solid #E0E0E0;
                min-height: {self.label_font_size + self.info_font_size + 24}px;
            }}
        ...
        for template_id in self.template_manager.list_templates():
            ...
            name_label.setStyleSheet(f"font-weight: 500; font-size: {self.label_font_size}px;")
            name_label.setWordWrap(True)

            desc_label = QLabel(metadata.description)
            desc_label.setStyleSheet(f"font-size: {self.info_font_size}px; color: #666;")
            desc_label.setWordWrap(True)

            item_layout.addWidget(name_label)
            item_layout.addWidget(desc_label)

            # Responsive item height based on content
    ...
    def _create_minimal_preview(self) -> QWidget:
        ...
        self.copy_btn.setStyleSheet(
            ...
            QPushButton {{
                ...
                background: white;
                padding: 4px 12px;
                font-size: {self.copy_button_font_size}px;
                font-weight: 500;
                min-height: 24px;
            }}
            QPushButton:hover:enabled {{
